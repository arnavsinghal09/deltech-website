...
**10.3 Deploy** — push to GitHub; import to Vercel; set env vars; point Supabase; verify Resend domain; add the Razorpay webhook URL; set the Vercel Cron job. PRs run CI only; merges deploy staging and then production.
