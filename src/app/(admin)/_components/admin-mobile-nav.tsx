  ...
  return (
    <div className="lg:hidden">
      ...
      <Drawer open={open} onOpenChange={setOpen} direction="left">
        <DrawerContent className="flex h-full w-72 flex-col">
          <DrawerHeader className="border-b border-border/70 text-left">
            <DrawerTitle className="display text-lg">{t("brand.name")}</DrawerTitle>
            <p className="eyebrow text-[10px]">Secretariat</p>
          </DrawerHeader>
