    ...
    <div className="section-shell relative grid gap-12 py-24 lg:grid-cols-[1fr_0.62fr] lg:items-end sm:py-32">
      ...
      <div className="border-t border-background/25 pt-7">
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          {content.publicSections.registration && <Link href={content.registrationOpen ? "/register" : "/register/closed"} className={cn(buttonVariants({ size: "lg" }), "bg-gold-400 text-stone-950 hover:bg-gold-300")}>{content.registrationOpen ? content.landingHero.ctaLabel : "See registration status"}<ArrowRight /></Link>}
